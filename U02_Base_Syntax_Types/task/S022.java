...
public class Calculator {
    public static String calculate(String input) {
        ...
        try {
            ...
            return Double.toString(calculate(a, b, operation));
        ...
        switch (operation) {
            ...
            case ("-"):
                if (a.contains(b)) {
                    ...
                    throw new IllegalArgumentException("Строка a не содержит строки b");
                }
            default:
                throw new IllegalArgumentException("Не верный тип операции для работы со строками");
        }
    }
    ...
    private static double calculate(double a, double b, String operation) {
        switch (operation) {
            ...
            case ("%"):
                return a % b;
            default:
                throw new IllegalArgumentException("Не верный тип операции");
        }
    }
